...
//   ? new URL(survey.vendorQuotaUrl).searchParams.get("tk")
//   : "";
//   const postbackToken = crypto.randomBytes(32).toString("hex");
//     const response = await SurveyResponse.create({
//       survey: surveyId,
//       user: userId,
//       rid,
